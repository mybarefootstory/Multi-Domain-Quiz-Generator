...
class QuizManager:
    ...
    # Another function to analyze while user takes the quiz
    def attempt_quiz(self):
        ...
        for i, q in enumerate(self.questions):
            ...
            if q['type'] == 'MCQ':
                if 'options' in q:  # Check if 'options' key exists
                    ...
                    st.error(f"Error: Missing 'options' for MCQ question {i+1}")
    ...
    # This function will evaluate the quiz
    ...
    def save_to_csv(self, filename='quiz_results.csv'):
        try:
            ...
            if not self.results:
                st.warning("No result to save. Please complete the quiz first")
                return None
...
def main():
    ...
    st.set_page_config(page_title="Multi Domian Quiz Generator", page_icon="📝")
    ...
    # Set page title
    st.title("Multi Domian Quiz Generator")
